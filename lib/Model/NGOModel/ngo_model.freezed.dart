...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,ngoName,address,phoneNo,bankName,accountNo,isVerified,cerficateUrl);

@override
String toString() {
  return 'NGOModel(id: $id, ngoName: $ngoName, address: $address, phoneNo: $phoneNo, bankName: $bankName, accountNo: $accountNo, isVerified: $isVerified, cerficateUrl: $cerficateUrl)';
}
...
@useResult
$Res call({
 String? id,@JsonKey(name: 'ngoName') String? ngoName,@JsonKey(name: 'address') String? address,@JsonKey(name: 'phoneNo') String? phoneNo,@JsonKey(name: 'bankName') String? bankName,@JsonKey(name: 'accountNo') String? accountNo,@JsonKey(name: 'isVerified') bool? isVerified,@JsonKey(name: 'certificateUrl') String? cerficateUrl
});
...
/// Create a copy of NGOModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? ngoName = freezed,Object? address = freezed,Object? phoneNo = freezed,Object? bankName = freezed,Object? accountNo = freezed,Object? isVerified = freezed,Object? cerficateUrl = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? id, @JsonKey(name: 'ngoName')  String? ngoName, @JsonKey(name: 'address')  String? address, @JsonKey(name: 'phoneNo')  String? phoneNo, @JsonKey(name: 'bankName')  String? bankName, @JsonKey(name: 'accountNo')  String? accountNo, @JsonKey(name: 'isVerified')  bool? isVerified, @JsonKey(name: 'certificateUrl')  String? cerficateUrl)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NGOModel() when $default != null:
return $default(_that.id,_that.ngoName,_that.address,_that.phoneNo,_that.bankName,_that.accountNo,_that.isVerified,_that.cerficateUrl);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? id, @JsonKey(name: 'ngoName')  String? ngoName, @JsonKey(name: 'address')  String? address, @JsonKey(name: 'phoneNo')  String? phoneNo, @JsonKey(name: 'bankName')  String? bankName, @JsonKey(name: 'accountNo')  String? accountNo, @JsonKey(name: 'isVerified')  bool? isVerified, @JsonKey(name: 'certificateUrl')  String? cerficateUrl)  $default,) {final _that = this;
switch (_that) {
case _NGOModel():
return $default(_that.id,_that.ngoName,_that.address,_that.phoneNo,_that.bankName,_that.accountNo,_that.isVerified,_that.cerficateUrl);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? id, @JsonKey(name: 'ngoName')  String? ngoName, @JsonKey(name: 'address')  String? address, @JsonKey(name: 'phoneNo')  String? phoneNo, @JsonKey(name: 'bankName')  String? bankName, @JsonKey(name: 'accountNo')  String? accountNo, @JsonKey(name: 'isVerified')  bool? isVerified, @JsonKey(name: 'certificateUrl')  String? cerficateUrl)?  $default,) {final _that = this;
switch (_that) {
case _NGOModel() when $default != null:
return $default(_that.id,_that.ngoName,_that.address,_that.phoneNo,_that.bankName,_that.accountNo,_that.isVerified,_that.cerficateUrl);case _:
  return null;
...
class _NGOModel implements NGOModel {
  const _NGOModel({this.id = '', @JsonKey(name: 'ngoName') this.ngoName = '', @JsonKey(name: 'address') this.address = '', @JsonKey(name: 'phoneNo') this.phoneNo = '', @JsonKey(name: 'bankName') this.bankName = '', @JsonKey(name: 'accountNo') this.accountNo = '', @JsonKey(name: 'isVerified') this.isVerified = false, @JsonKey(name: 'certificateUrl') this.cerficateUrl = ''});
...
/// Create a copy of NGOModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? ngoName = freezed,Object? address = freezed,Object? phoneNo = freezed,Object? bankName = freezed,Object? accountNo = freezed,Object? isVerified = freezed,Object? cerficateUrl = freezed,}) {
