...
import 'package:fyp_project/Pages/UploadDisaster/Camera/cameraCaptureDialog/camera_capture_dialog.dart';
            ...
            child: Scaffold(
              body: BlocListener<CameraBloc, CamerasState>(
                ...
                listener: (context, state) {
                  ...
                  {
                      showCameraCaptureDialog(context: context, file: state.captureFile!);
                  }
                },
