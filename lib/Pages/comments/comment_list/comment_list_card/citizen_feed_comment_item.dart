...
class _CitizenFeedCommentItemState extends State<CitizenFeedCommentItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocSelector<CommentBloc, CommentState, CommentModel?>(
      selector: (state) {
        return state.commentMap[widget.commentId] ;
      },
      builder: (context, model) {
        print("card is building...");
        if(model == null)
        {
          ...
          child: Column(
            children: [
              ...
              Row(
                ...
                children: [
                  Text(timeago.format(model.timeStamp!)),
