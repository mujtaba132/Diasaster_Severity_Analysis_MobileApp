...
class LoginBloc extends Bloc<LoginEvent, LoginState> {
  ...
  LoginBloc(this._loginrepository, this._firebaseRepository)
    : super(LoginState()) {
  ...
  void _onFormSubmit(OnFormSubmitEvent event, Emitter<LoginState> emit) async {
    ...
    await _loginrepository
        .firebaseLogin(email: state.email, password: state.password)
        .then((value) {
        ...
        .onError((error, stackTrace) {
          emit(
            state.copyWith(
              newLoginStatus: LoginStatus.error,
  ...
  void _ongoogleSignIn(
    ...
    await _loginrepository
        ...
        .then((userCredential) async {
          ...
          await _firebaseRepository.setData(
        ...
        .onError((error, stackTrace) {
          emit(
            state.copyWith(
              newGoogleLoginStatus: GoogleLoginStatus.error,
              newError: error.toString(),
            ),
          );
        });
